...
export default function GameCanvas() {
    ...
    const loadPhaser = async () => {
      ...
      const GameScene = class extends Phaser.Scene {
        ...
        create() {
          ...
          const wallThingsLayer = map.createLayer(
            "wall-objects",
            tilesets,
            0,
            0
          ...
          const floorObjectsLayer = map.createLayer(
            "floor-objects",
            tilesets,
            0,
            0
          );
          const surfaceItemsLayer = map.createLayer(
            "surface-items",
            tilesets,
            0,
            0
  ...
  return <div id="gameCanvas" className="w-full h-screen" />;
}
